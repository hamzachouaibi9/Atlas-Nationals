...
public class ComedyList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comedy_list);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Comedy Books");

        list = (RecyclerView) findViewById(R.id.comedy_list);
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Books").child("AllBooks");
        list.setLayoutManager(new LinearLayoutManager(this));
        progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Loading Comedy Books");
        progressDialog.show();
    ...
    public void onStart() {
        super.onStart();
        final Query query = databaseReference.orderByChild("genre").equalTo("Comedy");
        ...
        final FirebaseRecyclerAdapter<Book, BooksViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Book, BooksViewHolder>(Book.class,
            ...
            protected void populateViewHolder(BooksViewHolder viewHolder, Book model, int position) {
                ...
                Picasso.with(ComedyList.this).load(model.getImage()).into(viewHolder.image);
                ...
                viewHolder.ripple.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(ComedyList.this, BookPage.class);
