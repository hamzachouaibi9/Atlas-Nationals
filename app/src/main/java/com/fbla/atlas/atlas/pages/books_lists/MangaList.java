...
public class MangaList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Manga Books");

        list = (RecyclerView) findViewById(R.id.manga_list);
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Books").child("AllBooks");
        progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Loading Manga Books");
        progressDialog.show();
    ...
    public void onStart() {
        super.onStart();
        final Query query = databaseReference.orderByChild("genre").equalTo("Manga");
        ...
        final FirebaseRecyclerAdapter<Book, BooksViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Book, BooksViewHolder>(Book.class,
            ...
            protected void populateViewHolder(BooksViewHolder viewHolder, Book model, int position) {
                ...
                Picasso.with(MangaList.this).load(model.getImage()).into(viewHolder.image);
                ...
                viewHolder.ripple.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(MangaList.this, BookPage.class);
