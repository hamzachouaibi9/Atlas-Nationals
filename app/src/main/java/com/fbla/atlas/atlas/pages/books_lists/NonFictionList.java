...
public class NonFictionList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_non_fiction_list);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Non-Fiction Books");

        list =(RecyclerView) findViewById(R.id.non_fiction_list);
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Books").child("AllBooks");
        progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Loading Non Fiction Books");
        progressDialog.show();
    ...
    public void onStart() {
        super.onStart();
        final Query query = databaseReference.orderByChild("genre").equalTo("Non-Fiction");
        ...
        final FirebaseRecyclerAdapter<Book, BooksViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Book, BooksViewHolder>(Book.class,
            ...
            protected void populateViewHolder(BooksViewHolder viewHolder, Book model, int position) {
                ...
                Picasso.with(NonFictionList.this).load(model.getImage()).into(viewHolder.image);
                ...
                viewHolder.ripple.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(NonFictionList.this, BookPage.class);
