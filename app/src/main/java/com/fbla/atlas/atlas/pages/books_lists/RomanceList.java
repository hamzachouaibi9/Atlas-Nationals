...
public class RomanceList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Romance Books");

        list = (RecyclerView) findViewById(R.id.romance_list);
        list.setLayoutManager(new LinearLayoutManager(this));
        list.hasFixedSize();
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Books").child("AllBooks");
        progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Loading Romance Books");
        progressDialog.show();
    ...
    public void onStart() {
        super.onStart();
        final Query query = databaseReference.orderByChild("genre").equalTo("Romance");
        ...
        final FirebaseRecyclerAdapter<Book, BooksViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Book, BooksViewHolder>(Book.class,
            ...
            protected void populateViewHolder(BooksViewHolder viewHolder, Book model, int position) {
                ...
                Picasso.with(RomanceList.this).load(model.getImage()).into(viewHolder.image);
                ...
                viewHolder.ripple.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(RomanceList.this, BookPage.class);
