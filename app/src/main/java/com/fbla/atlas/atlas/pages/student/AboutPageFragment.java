 ...
 * {@link AboutPageFragment.OnFragmentInteractionListener} interface
...
public class AboutPageFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //Call The Buttons and find the views
        Button facebook = (Button) view.findViewById(R.id.facebook_btn);
        Button twitter = (Button) view.findViewById(R.id.twitter_btn);

        //Set the onclicklistener for both of them and launch the website
        facebook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("https://www.facebook.com/Atlas-FBLA-1896423094003523/"));
        ...
        twitter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("https://twitter.com/atlas_fbla"));
                startActivity(intent);
            }
        });
